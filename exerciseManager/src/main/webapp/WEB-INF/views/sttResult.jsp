	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				...
				<section>
					<header class="main">
						<h1>Voice Record File Upload</h1>
					</header>


					<!-- 날짜 및 요일 (0000년 0월 0일 0요일의 운동) -->
					<font size=4px> <%= cal.get(Calendar.YEAR) %>년 <%= cal.get(Calendar.MONTH)+1 %>월
						<%= cal.get(Calendar.DATE) %>일 <%= getDay(cal.get(Calendar.DAY_OF_WEEK)) %>의
						운동
					</font><br>
					<br>
					...
					<form id="sttForm" method="post" enctype="multipart/form-data">
						<b>운동을 기록할 음성 파일을 업로드 해주세요 :)<br>
						<br></b> <input type="file" id="uploadFile" name="uploadFile"><br>
						<br> 언어 : <select name="language">
							<option value="Kor" selected>한국어</option>
							<option value="Eng">영어</option>
							<option value="Jpn">일본어</option>
							<option value="Chn">중국어</option>
						</select><br> <input type="submit" value="운동 기록하기">

					</form>
					<br>

					<!-- STT : 음성 파일을 텍스트로 변환한 결과 -->
			...
			<div class="inner">
				...
				<nav id="menu">
					...
					<ul>
						...
						<li><span class="opener">Exercise Management</span>
							<ul>
								<li><a href="exer/exerciseListView">Exercise Record
										List</a></li>
						...
						<li><span class="opener">Diet Management</span>
							<ul>
